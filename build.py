...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.foodonthetable.regions.js')
	...
	f = os.path.join(cwd,'Classes','ComFoodonthetableRegionsModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','com.foodonthetable.regions.js']
